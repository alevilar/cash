...
$this->element("Risto.layout_modal_edit", array('title'=>'Arqueo'));
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="">
                        <?php 
                        if ( $puedeVerTodo ) {
                        echo $this->Html->link('Cambiar creador', array('action' => 'cambiar_creador', $arq['Arqueo']['id']), array('class' => 'btn-edit'));
                        } 
                        ?>
                    </li>
                  </ul>
